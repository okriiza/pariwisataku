   ...
   <div class="container-fluid">
      ...
      <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Gallery Pariwisata</li>
         </ol>
      </div>
      </div>
   </div>
         ...
         <div class="col-lg">
            <div class="card card-primary card-outline">
               <div class="card-header">
                  <h5 class="card-title">Data Gallery Pariwisata</h5>
                  <a href="{{ route('gallery.create')}}" class="btn btn-sm btn-primary shadow-sm float-right">
                     <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Gallery Pariwisata
                  </a>
               </div>
               <div class="card-body">
                  @if (session('status'))
